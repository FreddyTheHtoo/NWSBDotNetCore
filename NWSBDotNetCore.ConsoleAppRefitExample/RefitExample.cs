...
{
    private readonly IBlogApi _service = RestService.For<IBlogApi>("https://localhost:7041");
    ...
    private async Task CreateAysnc(string title, string author, string content)
    {
    ...
    private async Task UpdateAysnc(int id,string title, string author, string content)
    {
        BlogModel blog = new BlogModel
        {
            BlogTitle = title,
    ...
    private async Task DeleteAysnc(int id)
    {
        try
        {
